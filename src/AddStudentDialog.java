...
public class AddStudentDialog extends javax.swing.JDialog {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String program   = jComboBox1.getSelectedItem() != null ? jComboBox1.getSelectedItem().toString().trim() : "";
        String year      = jComboBox2.getSelectedItem().toString();
        String gender    = jComboBox3.getSelectedItem().toString();

        try {
            java.util.List<java.util.Map<String,String>> programs = SqliteDb.programList("code", false, 0, 0);
            if (programs.isEmpty()) throw new SqliteDb.StudentError("No programs available. Please add a program first.");
            jComboBox1.removeAllItems();
            for (java.util.Map<String,String> p : programs) {
                jComboBox1.addItem(p.get("code"));
            }
        ...
        try {
            ...
            SqliteDb.studentCreateWithId(id, firstname, lastname, program, year, gender);
