 ...
 * @author reyvi
 */
public class AddProgramDialog extends javax.swing.JDialog {

    /**
     * Creates new form AddStudentDialog
     */
    public AddProgramDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String college = jComboBox3.getSelectedItem() != null
                         ? jComboBox3.getSelectedItem().toString() : "";
        
        try {
            java.util.List<java.util.Map<String,String>> colleges = SqliteDb.collegeList("code", false, 0, 0);
            if (colleges.isEmpty()) throw new SqliteDb.ProgramError("No colleges available. Please add a college first.");
            jComboBox3.removeAllItems();
            for (java.util.Map<String,String> c : colleges) {
                jComboBox3.addItem(c.get("code"));
            }
        ...
        try {
            SqliteDb.programCreate(code, name, college);
            if (getOwner() instanceof GUI) {
                ((GUI) getOwner()).reloadAllTables();
            }
            dispose();
        } catch (SqliteDb.ProgramError | java.sql.SQLException e) {
            javax.swing.JOptionPane.showMessageDialog(this,
